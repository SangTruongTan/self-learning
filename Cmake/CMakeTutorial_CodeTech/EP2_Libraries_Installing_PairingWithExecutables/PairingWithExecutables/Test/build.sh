...
LIB_CONFIGURE="cmake -S $DIR/../AdderLib -B $DIR/../AdderLib/out/build -DCMAKE_INSTALL_PREFIX=$DIR/library/"
LIB_BUILD="cmake --build $DIR/../AdderLib/out/build --target install"
